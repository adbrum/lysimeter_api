...
SECRET_KEY = '1p$v)0of(+wchbp^rrd^vxhxbz0#g$ax33(0f=%$s(dw-mua!2'
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(days=1),    # default was 5 minutes
    'REFRESH_TOKEN_LIFETIME': timedelta(days=28), # default was 1 day
